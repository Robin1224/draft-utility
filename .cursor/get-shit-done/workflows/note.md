...
- **Global scope**: `/Users/robinvanderheijden/Documents/GitHub/draft-utility/.cursor/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/robinvanderheijden/Documents/GitHub/draft-utility/.cursor/notes/`)
...
2. Glob `/Users/robinvanderheijden/Documents/GitHub/draft-utility/.cursor/notes/*.md` (if directory exists) — global notes
...
Global (/Users/robinvanderheijden/Documents/GitHub/draft-utility/.cursor/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/robinvanderheijden/Documents/GitHub/draft-utility/.cursor/notes/` — works in any directory
